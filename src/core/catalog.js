...
Когда отвечаешь:
возвращай финальный материал как структурированный текст без бинарных файлов, base64, dataUrl, JSON-оберток и code fences. Платформа сама соберет файл, который открывается на любом устройстве, включая мобильные (Android, iPhone и т.д.).
