...
export const LLM_GLOBAL_QUALITY_RULES = `Работай по следующим правилам:
...
Когда отвечаешь:
возвращай финальный материал как структурированный текст без бинарных файлов, base64, dataUrl, JSON-оберток, ссылок на скачивание готового файла и code fences. Если для презентации нужны изображения, прямые Image URL на файлы изображений разрешены. Платформа сама соберет файл, который открывается на любом устройстве, включая мобильные (Android, iPhone и т.д.).
...
export const OFFERS = {
  ...
  [SERVICE_REPORT]: {
    ...
    deadlineInfo: 'Обычно 2-18 часов.',
    descriptionPoints: [
  ...
  [SERVICE_INDIVIDUAL_PROJECT]: {
    ...
    deadlineInfo: 'Обычно 24 часа - несколько дней.',
    descriptionPoints: [
  ...
  [SERVICE_COURSEWORK]: {
    ...
    deadlineInfo: 'Обычно 2 дня и больше.',
    descriptionPoints: [
  ...
  [SERVICE_CUSTOM_WORK]: {
    ...
    descriptionPoints: [
      ...
      'Рекомендуемый объем: 1-120 страниц или эквивалент.',
      'До 7 правок после выдачи готовой версии.'
    ],
    fields: [
      {
